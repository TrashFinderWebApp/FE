  ...
  return (
    <div>
      {locationList.length > 0 && isOpened && (
        <ul
          ref={dropDownRef}
          className="flex flex-col text-[0.875rem] whitespace-pre p-4 gap-1 rounded-md max-h-80 bg-white z-50 absolute shadow-lg w-full overflow-y-scroll [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:bg-[#AAAAAA] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-[#D9D9D9]"
        >
